...
set -U WAYLAND_DISPLAY wayland-0
...
alias nv='nvidia-smi'
alias mp=ncmpcpp
alias reflector='sudo reflector --latest 200 --sort rate --protocol https --country Worldwide,Australia --save /etc/pacman.d/mirrorlist'
alias mega="cd ~/Downloads/MegaBasterdLINUX; ./MegaBasterd.run"

# alias nand2tetris tools
alias n2thw=~/Documents/Deakin-Doc/SIT111/nand2tetris/tools/HardwareSimulator.sh
alias n2tcpu=~/Documents/Deakin-Doc/SIT111/nand2tetris/tools/CPUEmulator.sh
alias n2tass=~/Documents/Deakin-Doc/SIT111/nand2tetris/tools/Assembler.sh
alias n2tvm=~/Documents/Deakin-Doc/SIT111/nand2tetris/tools/VMEmulator.sh
alias n2tjc=~/Documents/Deakin-Doc/SIT111/nand2tetris/tools/JackComiler.sh

# alias Deakin folders
alias 112='z ~/Documents/Deakin_Doc/SIT112'
alias 111='z ~/Documents/Deakin_Doc/SIT111'
alias 103='z ~/Documents/Deakin_Doc/SIT103'
...
abbr wineprefix "WINEPREFIX="path/to/prefix" winetricks dotnet20 dotnet48 d3dcompiler_43 d3dcompiler_47 d3dx9 d3dx10 d3dx11_42 d3dx11_43 faudio vcrun2005 vcrun2008 vcrun2010 vcrun2012 vcrun2013 vcrun2015 quartz"
